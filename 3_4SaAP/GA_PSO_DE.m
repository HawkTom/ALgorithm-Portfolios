...
CostDecrease = abs([BestFormer.Cost-BestSol.GA.Cost BestFormer.Cost-BestSol.PSO.Cost BestFormer.Cost-BestSol.DE.Cost ]/BestFormer.Cost);
...
if fnum==8 || fnum==9
    plot(BestCost,'LineWidth',2,'Color',ColorS(14));
else
    semilogy(BestCost,'LineWidth',2,'Color',ColorS(14));
end
xlabel('Iteration');
ylabel('Cost');
grid on;
